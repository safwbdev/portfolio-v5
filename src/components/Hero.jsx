  ...
  return (
    <section className="hero" id="hero">
      ...
      <div className="hero__inner">
        <div className="hero__tag">FULL-STACK DEVELOPER · KUALA LUMPUR, MALAYSIA</div>
        <h1 className="hero__name">STEFAAN ARIZ<br /><span>FANGMAN</span></h1>
        <div className="hero__role">React · TypeScript · Node.js</div>
        <p className="hero__desc">Building fast, immersive web experiences — from cloud infrastructure to Three.js visuals.</p>
